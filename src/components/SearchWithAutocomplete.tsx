  ...
  return (
    <div className="flex-1 relative" ref={containerRef}>
      ...
      <input
        ...
        className="w-full h-9 pl-10 pr-10 py-2 bg-card border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
      />
      {searchValue && (
        <button
          onClick={() => {
            ...
            <ul className="py-1">
              {suggestions.map((suggestion, index) => (
                <li
                  ...
                  className={`px-4 py-2 cursor-pointer hover:bg-accent ${index === highlightedIndex ? "bg-accent" : ""
                    }`}
                >
